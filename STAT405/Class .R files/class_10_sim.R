...
my.timer <- timer.start("One core simulation")

set.seed(19390910) # Set the seed for reproducibility

#### Define constants
n.infringers <- 10000  # The number of infringers in the population
...
effort <- seq(100,1000,100) # Explore different levels of effort (notices per week)
